<template>
  ...
  <!-- SAFETY PROTOCOLS SECTIONS -->
   ...
   <div class="container-overall">
    ...
    <p class="p-text">• Always follow barangay and community rules during events.</p>
    <p class="p-text">• Wear appropriate clothing and safety gear, such as gloves, masks, and reflective vests.</p>
    ...
    <p class="p-text">• Report any suspicious activity or hazards to event organizers.</p>
    <p class="p-text">• Follow proper hygiene and sanitation practices, especially in food-related or medical events.</p>
    <p class="p-text">• Be aware of your surroundings and avoid restricted areas.</p>
    <p class="p-text">• Report hazards, accidents, or suspicious activities immediately.</p>
   </div>
   ...
   <div class="container-1">
    ...
    <div class="container-separation">
      ...
      <div class="container-sentences-wrapper">
  ...
  <div class="container-sentences safety-column">
    ...
    <p class="safety-p1">• Wear protective gloves when handling trash.</p>
    <p class="safety-p1">• Avoid sharp or hazardous materials without proper equipment.</p>
  </div>

  <div class="container-sentences safety-column">
    <h3 class="title-safety-specific">For Disaster Response</h3>
    <p class="safety-p">• Follow evacuation plans and designated safety zones.</p>
    <p class="safety-p">• Assist children, elderly individuals, and persons with disabilities.</p>
    <p class="safety-p">• Carry emergency kits with first-aid supplies, flashlights, and bottled water.</p>
  </div>

  <div class="container-sentences">
    <h3 class="title-safety-specific">For Medical Missions</h3>
    <p class="safety-p">• Sanitize hands before and after patient interactions.</p>
    <p class="safety-p">• Handle medical supplies with care and follow proper disposal procedures.</p>
    <p class="safety-p">• Ensure that all volunteers are briefed on hygiene protocols.</p>
  </div>
   ...
   <div class="container-1">
    ...
    <p class="p-text-1"><span>• Be Puncual & Reliable - </span>Arrive on time and commit to assigned tasks.</p>
    <p class="p-text-1"><span>• Respect & Professionalism - </span>Treat everyone with courtesy, regardless of background.</p>
    <p class="p-text-1"><span>• Follow Instructions - </span>Listen to organizers and comply with safety protocols.</p>
    <p class="p-text-1"><span>• Work as a Team - </span>Support fellow volunteers and communicate effectively.</p>
    <p class="p-text-1"><span>• No Disruptive Behavior - </span>Avoid unnecessary conflicts, inappropriate language, or distractions.</p>
    <p class="p-text-1"><span>• Protect Confidentiality - </span>Respect sensitive information shared during the event.</p>
    <p class="p-text-1"><span>• Take Initiative- </span>Offer help when needed and be proactive in problem-solving.</p>
    <p class="p-text-1"><span>• Stay Alert & Report Issues  - </span>Notify leaders of safety concerns or emergencies.</p>
   </div>
...
<style  src="/src/assets/CSS Volunteers/Safety Protocols.css"></style>