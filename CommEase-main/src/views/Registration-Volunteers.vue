...
<div class="registration-wrapper">
  ...
  <div class="container-things-needed" :class="{ 'disabled-form': !agreed }">
  ...
  <div class="button-submit">
    <button class="button-things-back" :disabled="!agreed" @click="resetRegistration">Back</button>
    <button class="button-things-submit" :disabled="!agreed" @click="handleSubmit">Submit</button>
  </div>
</div>
...
<div class="container-ideas">
  ...
  <p class="p-ideas">Is there anything that you could recommend for improving our event soon? (optional)</p>
  ...
  <button class="button-ideas-submit" @click="handleSubmit">Submit</button>
</div>
  </div>
...
const rawItems = [
  "Shovel", "Rake", "Gloves", "Boots", "Reusable Bottle", "Extra Shirt",
  "EWAN KO", "BASTA", "NUNO", "ENGKANTO"
];
