        ...
        <div class="event-info-container">
          <div class="event-header">
            ...
            <div class="event-meta">
              <p class="p-date"><span>Date Posted: </span>{{ formatDate(registration.date_posted) }}</p>
              <p class="p-slots"><span>Date: </span>{{ formatDate(registration.date) }}</p>
              <p class="p-slots"><span>Time: </span>{{ formatTime(registration.start_time) }} - {{ formatTime(registration.end_time) }}</p>
              <p class="p-location"><span>Location: </span>Barangay {{ registration.location }}</p>
              <p class="p-programs"><span>Programs: </span>{{ (registration.programs || []).join(', ') }}</p>
              <p class="p-organizer"><span>Organizer: </span>{{ registration.organizer?.first_name }} {{ registration.organizer?.last_name }}</p>
            </div>
          </div>
          ...
          <div class="event-content">
            ...
            <div class="content-section">
              ...
              <div class="task-separation">
                <div class="task-bullet-points">
                  <p v-for="(item, index) in registration.things_needed" :key="index" class="p-per-task">
                    • {{ item }}
                  </p>
                </div>
              </div>
