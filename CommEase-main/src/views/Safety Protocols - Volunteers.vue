<template>
	...
	<div class="container-overall" :class="{ 'sidebar-container-collapsed': !isOpen }">
		<div class="container-1">
			...
			<p class="p-text">
				• Wear appropriate clothing and safety gear, such as gloves,
				masks, and reflective vests.
			</p>
			<p class="p-text">
				• Be aware of emergency exits and assembly points.
			</p>
			...
			<p class="p-text">
				• Report hazards, accidents, or suspicious activities
				immediately.
			</p>
		</div>
		...
		<div class="container-12">
			...
			<div class="container-separation">
				<div class="container-sentences-wrapper" :class="{ '.sidebar-sentences-collapsed': isOpen }">
					<div class="container-sentences safety-column">
						<h3 class="title-safety-specific">
							For Clean-up Drives
						</h3>
						...
						<p class="safety-p1">
							• Avoid sharp or hazardous materials without proper
							equipment.
						</p>
					</div>
					...
					<div class="container-sentences safety-column">
						...
						<p class="safety-p">
							• Follow evacuation plans and designated safety
							zones.
						</p>
						<p class="safety-p">
							• Assist children, elderly individuals, and persons
							with disabilities.
						</p>
						<p class="safety-p">
							• Carry emergency kits with first-aid supplies,
					...
					<div class="container-sentences">
						...
						<p class="safety-p">
							• Sanitize hands before and after patient
							interactions.
						</p>
						<p class="safety-p">
							• Handle medical supplies with care and follow
							proper disposal procedures.
						</p>
						<p class="safety-p">
							• Ensure that all volunteers are briefed on hygiene
							protocols.
						</p>
					</div>
				</div>
		...
		<div class="container-1">
			...
			<p class="p-text-1">
				<span>• Be Puncual & Reliable - </span>Arrive on time and commit
				to assigned tasks.
			</p>
			<p class="p-text-1">
				<span>• Respect & Professionalism - </span>Treat everyone with
				courtesy, regardless of background.
			</p>
			<p class="p-text-1">
				<span>• Follow Instructions - </span>Listen to organizers and
			...
			<p class="p-text-1">
				<span>• No Disruptive Behavior - </span>Avoid unnecessary
				conflicts, inappropriate language, or distractions.
			</p>
			<p class="p-text-1">
				<span>• Protect Confidentiality - </span>Respect sensitive
				information shared during the event.
			</p>
			<p class="p-text-1">
				<span>• Take Initiative- </span>Offer help when needed and be
				proactive in problem-solving.
			</p>
			<p class="p-text-1">
				<span>• Stay Alert & Report Issues - </span>Notify leaders of
